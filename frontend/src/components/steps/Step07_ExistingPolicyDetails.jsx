        ...
        <StepWrapper className="space-y-10">
            <div className="text-center space-y-2">
                <div className="inline-block bg-brand-accent/20 border border-brand-accent/30 px-3 py-1 rounded-full mb-2">
                    <span className="text-[10px] font-black uppercase tracking-widest text-brand-accent">Phase 3: Policy Inventory</span>
                </div>
                <h2 className="text-3xl font-black text-white">Share your <span className="text-brand-accent text-italic">policy</span> details</h2>
